...
export const NetworkPostureCenter = memo<NetworkPostureCenterProps>(
  ({ netPosture, netifs, vpnStatus, online, onUpdate, onRefreshVpn, onError, onSuccess, onBack }) => {
    ...
    return (
      <div className="networkPostureCenter">
        ...
        <div className="networkPostureCenterContent">
          <PrivacyStatusCard online={online} onError={onError} onSuccess={onSuccess} />
          <VpnDetectionWidget vpnStatus={vpnStatus} netifs={netifs} onKillSwitchToggle={handleVpnWidgetClick} />
          <BindInterfaceControl
            ...
            onSuccess={onSuccess}
          />
          <LeakProofIndicator netPosture={netPosture} />
          ...
          <ConnectionPolicyToggles online={online} onUpdate={onUpdate} onError={onError} onSuccess={onSuccess} />
          <ThreatModelPresets online={online} onUpdate={onUpdate} onError={onError} onSuccess={onSuccess} />
        </div>
      </div>
    );
  }
