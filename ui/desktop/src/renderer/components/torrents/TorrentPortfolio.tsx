  ...
  ({
    ...
    const filteredTorrents = useMemo(() => {
      ...
      if (debouncedSearchQuery.trim()) {
        ...
        filtered = filtered.filter((t) => t.name.toLowerCase().includes(query) || t.id.toLowerCase().includes(query));
      }
    ...
    return (
      <div className="torrentPortfolio">
        <div className="torrentPortfolioHeader">
          <div className="torrentPortfolioTitle">Torrent queue</div>
          <ColumnChooser
        ...
        <TorrentTable
          ...
          onSort={handleSort}
          visibleColumns={visibleColumns}
          rowSnapshotPollMs={rowSnapshotPollMs}
        />
      </div>
    );
  }
