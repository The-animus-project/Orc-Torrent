    ...
    return (
      <div className="bulkActionPanel">
        ...
        <div className="bulkActionPanelActions">
          <button className="btn" onClick={onStart} disabled={!online} aria-label="Start Selected Torrents">
            START
          </button>
          <button className="btn" onClick={onPause} disabled={!online} aria-label="Pause Selected Torrents">
            PAUSE
          </button>
          <button className="btn" onClick={onStop} disabled={!online} aria-label="Stop Selected Torrents">
            STOP
          </button>
          ...
          <button className="btn ghost" onClick={onMoveData} disabled={!online}>
            MOVE DATA
          </button>
          <button className="btn ghost" onClick={onExportTorrent} disabled={!online}>
            EXPORT .TORRENT
          </button>
          <button className="btn ghost" onClick={onSetLimits} disabled={!online}>
            SET LIMITS
          </button>
            ...
            {showLabelMenu && (
              <div className="bulkActionDropdown" role="menu">
                {availableLabels.length > 0 ? (
                  ...
                  <div className="bulkActionDropdownEmpty" role="status">
                    No labels available
                  </div>
                )}
              </div>
          ...
          <div className="divider" />
          <button className="btn" onClick={onRemove} disabled={!online} aria-label="Remove Selected Torrents">
            REMOVE
          </button>
        </div>
      </div>
