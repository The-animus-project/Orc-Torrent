...
export const PeersTab = memo<PeersTabProps>(({ torrent, torrentStatus, online, onError }) => {
  ...
  useAdaptiveInterval(fetchPeers, intervals.peers, online);
      ...
      {online && (
        <div className="peerKpiHeader">
          <div className="peerKpiSection">
            ...
            {uniqueIPs !== peers.length && <div className="peerKpiSubtext">{uniqueIPs} unique IPs</div>}
          </div>
          <div className="peerKpiSection">
          ...
          {torrentStatus && (
            <div className="peerKpiSection">
              ...
              <div className="peerKpiValue">
                ...
                peers.length === 0 &&
                (torrentStatus.down_rate_bps ?? 0) === 0 &&
                (torrentStatus.up_rate_bps ?? 0) === 0
                  ? "connecting…"
                  : torrentStatus.state}
              </div>
        ...
        <div className="peerList">
          {!online ? (
            <div className="empty">
              ...
              <div className="emptySubtitle">Connect to daemon to view peer information</div>
            </div>
            ...
            <div className="empty">
              ...
              <div className="emptySubtitle">
                Peers will appear here when connections are established.
                <br />
            ...
            <div className="empty">
              ...
              <div className="emptySubtitle">No peers match your filter "{filter}"</div>
            </div>
          ) : (
                ...
                <thead>
                  <tr>
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "ip" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "country" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                      <div className="tableHeaderContent">
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "client" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                      <div className="tableHeaderContent">
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "progress" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                      <div className="tableHeaderContent">
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "downRate" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "upRate" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                      <div className="tableHeaderContent" style={{ justifyContent: "flex-end" }}>
                    ...
                    <th
                      ...
                      scope="col"
                      aria-sort={
                        sortField === "status" ? (sortDirection === "asc" ? "ascending" : "descending") : undefined
                      }
                    >
                      <div className="tableHeaderContent">
                      ...
                      <tr key={peer.id} className={`tableRow ${status.class}`}>
                        <td className="tableCell">
                          <div className="peerAddress">
                            <span className="peerIp" title={ipAddr}>
                              {peer.ip}
                            </span>
                        ...
                        <td className="tableCell">
                          <div className="peerClient">
                            ...
                            {clientInfo.version && <span className="peerClientVersion">{clientInfo.version}</span>}
                          </div>
                        </td>
                        <td className="tableCell">
