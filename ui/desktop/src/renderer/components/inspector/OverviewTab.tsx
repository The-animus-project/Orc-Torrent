...
export const OverviewTab = memo<OverviewTabProps>(
  ({ torrent, status, overlay, online, onUpdate, onError, onSuccess }) => {
    ...
    const fetchTrackerStats = useCallback(async () => {
      if (!online) return;
      try {
        const data = await getJson<{ trackers: Array<{ seeders: number | null; leechers: number | null }> }>(
          `/torrents/${torrent.id}/trackers`
        );
    ...
    useAdaptiveInterval(fetchTrackerStats, intervals.trackers, online);
        ...
        <div className="inspectorSection">
          ...
          <div className="inspectorGrid">
            <div className="inspectorField">
              ...
              <div className="inspectorFieldValue" style={{ fontFamily: "monospace", fontSize: "12px" }}>
                {torrent.id}
              </div>
            </div>
            <div className="inspectorField">
        ...
        <div className="inspectorSection">
          ...
          <div className="inspectorGrid">
            ...
            <div className="inspectorField">
              ...
              <div className="inspectorFieldValue">{totalSeeders !== null ? totalSeeders : "—"}</div>
            </div>
            <div className="inspectorField">
              <div className="inspectorFieldLabel">Leechers (Swarm)</div>
              <div className="inspectorFieldValue">{totalLeechers !== null ? totalLeechers : "—"}</div>
            </div>
            <div className="inspectorField">
