...
export const TorrentInspector = memo<TorrentInspectorProps>(
  ({ torrent, status, overlay, events, online, onUpdate, onError, onSuccess }) => {
        ...
        <div className="torrentInspector">
          <div className="torrentInspectorEmpty">
            ...
            <div style={{ fontSize: "12px", color: "var(--text-muted)" }}>
              Select a torrent from the list to view details
            </div>
          </div>
        </div>
      );
    ...
    return (
      <div className="torrentInspector">
        ...
        <div className="torrentInspectorContent">
          ...
          {activeTab === "files" && (
            <FilesTab torrent={torrent} online={online} onUpdate={onUpdate} onError={onError} onSuccess={onSuccess} />
          )}
          {activeTab === "peers" && (
            <PeersTab
              torrent={torrent}
