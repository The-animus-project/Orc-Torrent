  ...
  ({
    ...
    return (
      <div className="navigationRail">
        ...
        {labels.length > 0 && (
          <div className="navSection">
            ...
            <div className="navLabels">
              {labels.map((label) => (
                <button key={label} className="navLabel" onClick={() => onLabelClick(label)}>
                  {label}
                </button>
              ))}
            </div>
        ...
        {/* Watch Folders */}
        <div className="navSection">
          <button className="navWatchFolder" onClick={onWatchFoldersClick}>
            <span>Watch Folders</span>
            {watchFoldersCount > 0 && <span className="navBadge">{watchFoldersCount}</span>}
          </button>
        </div>
