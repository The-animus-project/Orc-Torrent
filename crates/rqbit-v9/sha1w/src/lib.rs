...
// Cargo unifies features across a workspace build. Prefer the desktop
// crypto-hash implementation when both platform features are present.
#[cfg(all(feature = "sha1-ring", not(feature = "sha1-crypto-hash")))]
mod ring_impl {
    use super::ISha1;
