...
pub struct ListenerOptions {
    ...
    pub announce_port: Option<u16>,
    pub ipv4_only: bool,
    /// Treat a requested transport bind failure as fatal instead of degrading.
    pub require_all_transports: bool,
}
    ...
    pub(crate) async fn start(
        ...
        let utp_socket = if self.mode.utp_enabled() {
            ...
            match bind_result {
                ...
                Err(e) if tcp_socket.is_some() && !self.require_all_transports => {
