...
pub(crate) struct PeerCountersAtomic {
    ...
    pub scheduler_rtt_ms: AtomicU64,
    pub scheduler_goodput_bps: AtomicU64,
    pub scheduler_choke_events: AtomicU64,
    pub scheduler_choke_ratio_ppm: AtomicU32,
    pub scheduler_reject_events: AtomicU64,
    pub scheduler_reject_ratio_ppm: AtomicU32,
    pub scheduler_timeout_events: AtomicU64,
    pub scheduler_consecutive_timeouts: AtomicU32,
    pub scheduler_available_pieces: AtomicU32,
    pub scheduler_total_pieces: AtomicU32,
    pub scheduler_outstanding_bytes: AtomicU64,
    pub scheduler_outstanding_requests: AtomicU32,
    pub scheduler_target_requests: AtomicU32,
    pub scheduler_stalled_reassignments: AtomicU64,
}
